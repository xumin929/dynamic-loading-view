...
/*import ReduxAsyncConnect from 'jdcloudecc/routes/ReduxAsyncConnect';
console.log("))))))))))))))",ReduxAsyncConnect)*/

import Rac from 'jdcloudecc/routes/ReduxAsyncConnect';
export default function reduxAsyncConnect(props){
  return Rac(props);
}
