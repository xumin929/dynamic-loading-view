 ...
 *     });
 *
 * OtherInformation methods and properties can be added the same way, or directly to the
 * prototype.
 *
 *    var Animal = CoreObject.extend({
 *       init: function(name){
...
(function(){
  ...
  // OtherInformation browsers don't have any hints of which version they might follow yet,
 ...
 * Indicates that the text track is not active. OtherInformation than for the purposes of exposing the track in the DOM, the user agent is ignoring the text track.
